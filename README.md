...
- Просмотр изображения в модальном окне: можно переключаться стрелками, сохранить файл, открыть оригинал, скопировать ссылку, перейти в чат генерации или добавить картинку в референсы.
